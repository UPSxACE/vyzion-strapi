...
LABEL "traefik.http.routers.vystrapi-service.entrypoints"="websecure"
LABEL "traefik.http.routers.vystrapi-service.tls"="true"
LABEL "traefik.http.routers.vystrapi-service.tls.certresolver"="$CERTRESOLVER"
